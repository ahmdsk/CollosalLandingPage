...
export default function Footer() {
  return (
    <div className="flex min-[300px]:flex-wrap pt-24 md:mx-16 min-[300px]:mx-8">
        <div className="xl:w-3/12 min-[300px]:w-full min-[300px]:mb-10">
        ...
        <div className="xl:w-3/12 min-[300px]:w-full min-[300px]:mb-10 space-y-4">
