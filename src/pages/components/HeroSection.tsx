    ...
    <div className="flex justify-center text-center pt-12">
        <div className="w-[600px]">
            ...
            <div className="flex gap-5 justify-center pt-9">
                <Button text="Send Quote" className="bg-[#6016FC] px-8 py-3 rounded-sm font-medium" />
                <Button text="Learn More" className="bg-white bg-opacity-10 px-8 py-3 rounded-sm font-medium" />
            </div>
        </div>
    </div>
  )
